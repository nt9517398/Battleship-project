...
public static class MenuController
{
    ...
    public static string DrawDificulty = "Medium Difficulty";
    private static string[][] _menuStructure = {
        new string[] {"PLAY", "SETUP", "SCORES", "QUIT", "HELP"},
    ...
    // '' <remarks>
    // '' The menu text comes from the _menuStructure field. The level indicates the height of the menu, to enable sub menus. 
    //    The xOffset repositions the menu horizontally to allow the submenus to be positioned correctly.
    // '' </remarks>
    ...
    //Used in HandleMenuInput in MenuController.cs
    ...
    private static void PerformMainMenuAction(int button)
    {
        switch (button)
        {
            ...
            case MAIN_MENU_HELP_BUTTON:
                GameController.AddNewState(GameState.ViewingInformation);
                break;
    ...
    private static void PerformSetupMenuAction(int button)
    {
        switch (button)
        {
            case SETUP_MENU_EASY_BUTTON:
                DrawDificulty = "Easy Difficulty";
                GameController.SetDifficulty(AIOption.Medium);
                SwinGame.RefreshScreen();
                break;
            case SETUP_MENU_MEDIUM_BUTTON:
                DrawDificulty = "Medium Difficulty";
                GameController.SetDifficulty(AIOption.Medium);
                SwinGame.RefreshScreen();
                break;
            case SETUP_MENU_HARD_BUTTON:
                DrawDificulty = "Hard Difficulty";
